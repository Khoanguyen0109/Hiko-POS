...
import dishRecipeRoute from "./routes/dishRecipeRoute.js";
import toppingRecipeRoute from "./routes/toppingRecipeRoute.js";
...
app.use("/api/recipe", dishRecipeRoute);
app.use("/api/topping-recipe", toppingRecipeRoute);
