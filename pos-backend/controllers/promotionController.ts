...
const getPromotions = async (req, res, next) => {
  try {
    ...
    // Build filter query
    const filter: MongoFilter = { store: req.store._id };
...
const getPromotionAnalytics = async (req, res, next) => {
  try {
    ...
    const promotionMatchStage: MongoFilter = { store: req.store._id };
    const orderMatchStage: MongoFilter = {
...
const validateCouponCode = async (req, res, next) => {
  try {
    ...
    const couponFilter: MongoFilter = {
